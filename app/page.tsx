    ...
    <>
      ...
      <nav
          className={`w-full z-20 top-0 start-0 fixed text-white transition-all duration-300 ${
            scrolled ? "bg-[#08023D] shadow-md" : "bg-transparent"
          }`}
        >
    ...
    <main className="relative z-10 max-w-screen-xl mx-auto px-4">
      <section className="w-full flex flex-col gap-16 items-center justify-center text-black min-h-screen">
          ...
          <div className="relative w-full">
            ...
            <div className="absolute top-[72.5%] left-1/2 transform -translate-x-1/2 w-10/12 h-1 bg-[#4285F4] z-0" />
        ...
        <main className="relative z-10 max-w-screen-xl mx-auto px-4">
          <section className=" w-full flex flex-col items-center justify-center text-center text-black gap-6">
            <div className='bg-white/60 p-12 rounded-md border-gray-300 border-2'>
              ...
              {/* Q&A Section */}
              <div className="rounded-2xl w-full p-6 md:p-10 text-start">
                {currentQuestions.map((item, idx) => (
                  <div key={idx} className="pb-6 my-6 w-full flex border-b border-gray-300">
                    <h3 className="text-lg font-semibold w-5/12 text-black mb-2">
                      {item.question}
                    </h3>
                    <p className="text-gray-600 text-sm w-7/12 leading-relaxed">
                      {item.answer}
                    </p>
